---
name: "rabbitmq-broker-scaling"
description: "Guia prático de escalabilidade horizontal e vertical, réplicas e balanceamento de carga. para a tecnologia rabbitmq-broker."
---

# Skill de Agente: RABBITMQ-BROKER - Escalabilidade e cluster

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Escalabilidade e cluster** para a tecnologia **rabbitmq-broker** no ecossistema PlantiuIA.
