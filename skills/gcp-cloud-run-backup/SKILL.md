---
name: "gcp-cloud-run-backup"
description: "Estratégias de backup de segurança, snapshots locais e recuperação de desastres. para a tecnologia gcp-cloud-run."
---

# Skill de Agente: GCP-CLOUD-RUN - Backup e redundância

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Backup e redundância** para a tecnologia **gcp-cloud-run** no ecossistema PlantiuIA.
