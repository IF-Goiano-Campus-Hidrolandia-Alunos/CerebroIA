---
name: "rabbitmq-broker-backup"
description: "Estratégias de backup de segurança, snapshots locais e recuperação de desastres. para a tecnologia rabbitmq-broker."
---

# Skill de Agente: RABBITMQ-BROKER - Backup e redundância

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Backup e redundância** para a tecnologia **rabbitmq-broker** no ecossistema PlantiuIA.
