---
name: "gcp-cloud-run-scaling"
description: "Guia prático de escalabilidade horizontal e vertical, réplicas e balanceamento de carga. para a tecnologia gcp-cloud-run."
---

# Skill de Agente: GCP-CLOUD-RUN - Escalabilidade e cluster

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Escalabilidade e cluster** para a tecnologia **gcp-cloud-run** no ecossistema PlantiuIA.
