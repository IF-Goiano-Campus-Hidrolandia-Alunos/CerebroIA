---
name: "influxdb-ts-monitoring"
description: "Metodologias de instrumentação de telemetria, logs estruturados e alertas de infraestrutura. para a tecnologia influxdb-ts."
---

# Skill de Agente: INFLUXDB-TS - Observabilidade e monitoramento

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Observabilidade e monitoramento** para a tecnologia **influxdb-ts** no ecossistema PlantiuIA.
