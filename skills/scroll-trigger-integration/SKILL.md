---
name: Scroll Trigger Integration
description: Habilidade tecnica para integration utilizando scroll trigger com foco em animacao estrategica e intencional.
---

# Scroll Trigger - Integration

Esta skill descreve as diretrizes praticas e operacionais para a execucao de integration usando scroll-trigger.
