---
name: "rabbitmq-broker-configuration"
description: "Instruções de configuração detalhada de execução e dependências da ferramenta. para a tecnologia rabbitmq-broker."
---

# Skill de Agente: RABBITMQ-BROKER - Configuração técnica

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Configuração técnica** para a tecnologia **rabbitmq-broker** no ecossistema PlantiuIA.
