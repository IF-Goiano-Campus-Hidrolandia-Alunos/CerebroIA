---
name: "influxdb-ts-scaling"
description: "Guia prático de escalabilidade horizontal e vertical, réplicas e balanceamento de carga. para a tecnologia influxdb-ts."
---

# Skill de Agente: INFLUXDB-TS - Escalabilidade e cluster

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Escalabilidade e cluster** para a tecnologia **influxdb-ts** no ecossistema PlantiuIA.
