...
description: "Diretrizes de migração de versões e refatoração de infraestrutura. para a tecnologia vault-secrets."
---

# Skill de Agente: VAULT-SECRETS - Migração de ambientes

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Migração de ambientes** para a tecnologia **vault-secrets** no ecossistema PlantiuIA.
