...
description: "Metodologias de instrumentação de telemetria, logs estruturados e alertas de infraestrutura. para a tecnologia gcp-cloud-run."
---

# Skill de Agente: GCP-CLOUD-RUN - Observabilidade e monitoramento

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Observabilidade e monitoramento** para a tecnologia **gcp-cloud-run** no ecossistema PlantiuIA.
