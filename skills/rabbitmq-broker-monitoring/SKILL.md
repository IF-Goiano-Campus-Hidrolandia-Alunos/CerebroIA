---
name: "rabbitmq-broker-monitoring"
description: "Metodologias de instrumentação de telemetria, logs estruturados e alertas de infraestrutura. para a tecnologia rabbitmq-broker."
---

# Skill de Agente: RABBITMQ-BROKER - Observabilidade e monitoramento

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Observabilidade e monitoramento** para a tecnologia **rabbitmq-broker** no ecossistema PlantiuIA.
