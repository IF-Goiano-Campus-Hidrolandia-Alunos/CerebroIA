---
name: "influxdb-ts-configuration"
description: "Instruções de configuração detalhada de execução e dependências da ferramenta. para a tecnologia influxdb-ts."
---

# Skill de Agente: INFLUXDB-TS - Configuração técnica

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Configuração técnica** para a tecnologia **influxdb-ts** no ecossistema PlantiuIA.
