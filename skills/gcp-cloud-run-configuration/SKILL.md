---
name: "gcp-cloud-run-configuration"
description: "Instruções de configuração detalhada de execução e dependências da ferramenta. para a tecnologia gcp-cloud-run."
---

# Skill de Agente: GCP-CLOUD-RUN - Configuração técnica

## Descrição Operacional
Esta skill instrui o agente como lidar com tarefas de **Configuração técnica** para a tecnologia **gcp-cloud-run** no ecossistema PlantiuIA.
