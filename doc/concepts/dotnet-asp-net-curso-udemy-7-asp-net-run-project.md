...
## Rodando o projeto
---
É bem simples rodar o projeto no Visual Studio, onde após configurado o $\color{lightgreen}{\sf launchSettings.json}$ com as rotas definidas no [[concepts/dotnet-asp-net-curso-udemy-6-asp-net-controller]] somente precisamos clicar no Runner desejado, possuindo 3 principais:
