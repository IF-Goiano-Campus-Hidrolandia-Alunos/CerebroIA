...
Entenda o [[concepts/dotnet-asp-net-curso-udemy-2-asp-net-rest]] neste artigo.
Entenda como criar um template ASP.NET neste artigo: [[concepts/dotnet-asp-net-curso-udemy-1-asp-net-template]]
...
1. [[concepts/dotnet-asp-net-curso-udemy-3-asp-net-model]]
2. [[concepts/dotnet-asp-net-curso-udemy-4-asp-net-services]]
---
...
---
Agora que temos definido os métodos que iremos usar para fazer as requisições que se encontram explicados na Implementation dos [[concepts/dotnet-asp-net-curso-udemy-4-asp-net-services]] podemos fazer nossos métodos do Controller para interagirmos com as requisições de entrada na API.
