...
- Backlog restante (nao bloqueia mais nada): limpeza dos setStyle inline internos dos subeditores (Community 33, Image 18, Audio 13, Animation 10) e FxNotesWindow; validacao manual em GUI de tema/layout/configuracoes/inspector; paridade pos-F4 ainda pendente: undo/redo (Command), import imagem->sprite dedicado, prefabs (PrefabManager). [Inspector completo e anexar script: FEITOS.]
