...
updated: 2026-06-17
revisao: F4 COMPLETA + Configuracoes centralizadas + Inspector completo (paridade) + correcoes de tema/highlighting — 2026-06-17
---
...
- Backlog restante (nao bloqueia nada): validacao manual em GUI; paridade pos-F4 ainda pendente: undo/redo (Command), import imagem->sprite dedicado, prefabs (PrefabManager). [Inspector completo, anexar script e tematizacao dos subeditores: FEITOS.]
