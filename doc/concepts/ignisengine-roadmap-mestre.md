...
Auditoria de 2026-06-14. Documento completo no projeto: `IgnisEngine/doc/MASTER_ROADMAP.md`. Substitui o roadmap antigo de 10 itens como referência principal (ver [[concepts/ignisengine-roadmap]]).
