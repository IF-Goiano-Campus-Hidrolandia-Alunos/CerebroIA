...
1. [[concepts/dotnet-asp-net-curso-udemy-1-asp-net-template]]
2. [[concepts/dotnet-asp-net-curso-udemy-2-asp-net-rest]]
3. [[concepts/dotnet-asp-net-curso-udemy-3-asp-net-model]]
4. [[concepts/dotnet-asp-net-curso-udemy-4-asp-net-services]]
5. [[concepts/dotnet-asp-net-curso-udemy-5-asp-net-controller-template]]
6. [[concepts/dotnet-asp-net-curso-udemy-6-asp-net-controller]]
7. [[concepts/dotnet-asp-net-curso-udemy-7-asp-net-run-project]]
---
...
Agora temos que pegar as informações do nosso [[concepts/dotnet-asp-net-curso-udemy-3-asp-net-model]] e colocar em formato JSON na aba **Body** onde iremos definir os valores do nosso Objeto Person, para isso deve ser seguido os passos abaixo.
1. Acesse a aba **Body**
