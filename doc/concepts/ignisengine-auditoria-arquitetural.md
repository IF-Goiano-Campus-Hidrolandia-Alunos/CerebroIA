...
Auditoria arquitetural do IgnisEngine (2026-06-14). Doc completo: `IgnisEngine/doc/ARCHITECTURE_AUDIT.md`. Ver também auditoria anterior [[concepts/ignisengine-auditoria]].
