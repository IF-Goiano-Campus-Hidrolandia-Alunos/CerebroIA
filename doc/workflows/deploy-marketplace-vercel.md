...
1. Vercel: New Project -> importar `ThyagoToledo/IginisMarketePlace` -> Deploy (Next.js auto-detectado).
...
- Login com GitHub no topo do site; ThyagoToledo/FeronZerbana entram como admin (veem `/admin`).
