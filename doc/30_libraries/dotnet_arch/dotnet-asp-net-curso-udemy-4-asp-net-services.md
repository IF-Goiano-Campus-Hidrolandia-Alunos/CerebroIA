...
Os Services são usados para manter os [[30_libraries/dotnet_arch/dotnet-asp-net-curso-udemy-6-asp-net-controller]] enxutos e o código organizado. Em vez de colocar toda a lógica de negócios em um [[30_libraries/dotnet_arch/dotnet-asp-net-curso-udemy-6-asp-net-controller]], você pode criar um Service para lidar com essa lógica e, em seguida, injetar esse serviço no controlador. Isso torna o código mais fácil de manter e testar.
...
---
Agora iremos construir a estrutura base dos métodos que iremos utilizar em nossos Controllers, utilizando o sistema do CRUD explicado em [[30_libraries/dotnet_arch/dotnet-asp-net-curso-udemy-2-asp-net-rest]] onde temos os seguintes tipos:
