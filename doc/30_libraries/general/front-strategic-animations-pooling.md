---
tags: ['design', 'animacoes', 'ux', 'front-strategic-animations', 'pooling']
updated: 2026-06-26
---

## Definicao

Pooling e reutilizacao de elementos graficos na arvore DOM para otimizar transicoes de listas. Aplicacao pratica da filosofia de animacao estrategica, focando na restricao e proposito.
...
### Principios Fundamentais Aplicados a POOLING
...
- **Expressao da Marca**: O comportamento de pooling deve estar perfeitamente alinhado com a identidade visual da marca (movimentos precisos para tecnologia, organicos para biologia).
