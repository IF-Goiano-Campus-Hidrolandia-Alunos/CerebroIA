---
tags: ['design', 'animacoes', 'ux', 'front-strategic-animations', 'redundancy']
updated: 2026-06-26
---

## Definicao

Redundancia e fallbacks estaticos para acessibilidade em dispositivos de baixo processamento. Aplicacao pratica da filosofia de animacao estrategica, focando na restricao e proposito.
...
### Principios Fundamentais Aplicados a REDUNDANCY
...
- **Expressao da Marca**: O comportamento de redundancy deve estar perfeitamente alinhado com a identidade visual da marca (movimentos precisos para tecnologia, organicos para biologia).
