...
- Remoto: https://github.com/Colaborador1/PlantiumAI.git
- Identidade GLOBAL da máquina é de outra pessoa (kkraties13) — usar config LOCAL do repo: Colaborador1 / colaborador1@email.com (já configurado)
- Credencial do Windows Credential Manager: Colaborador1 (auth correta)
